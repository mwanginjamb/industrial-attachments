...
<div class="site-index">
    <!-- Header Section -->
    <header class="mb-12">
        <h1 class="font-headline text-5xl font-extrabold text-on-surface tracking-tighter mb-2">Welcome back,
                        ...
                        hover:bg-surface-container-low transition-colors duration-200">
                            ...
                            <div class="flex items-center gap-4 ml-auto">
                                ...
                                <?php if ($uploaded): ?>
                                    ...
                                    <?= $this->render('_inline_form', ['t' => $doc, 'model' => $model, 'file' => new File(), 'labelIcon' => '<span class="material-symbols-outlined text-[18px]">cloud_upload</span> Replace']) ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <?= $this->render('_inline_form', ['t' => $doc, 'model' => $model, 'file' => new File(), 'labelIcon' => '<span class="material-symbols-outlined text-[18px]">upload</span> Upload']) ?>
