            ...
            <section class="bg-surface-container-lowest rounded-xl p-8 shadow-sm ring-1 ring-outline-variant/10">
                ...
                <div class="space-y-4">
                    <?php foreach ($docTemplates as $doc): ?>
                        ...
                        <div class="group flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-surface rounded-xl
                                <?= $uploaded ? '' : 'ring-2 ring-error/5' ?>
                                hover:bg-surface-container-low transition-colors duration-200 gap-4 sm:gap-0">
                            ...
                            <div class="flex items-center justify-between w-full sm:w-auto gap-4">
                                ...
                                <?php else: ?>
                                    ...
                                    <a href="<?= Url::to(['/document/upload', 'type' => 'pdf']) ?>"
